# Professional GitHub Copilot for Developers </br> _with advanced AI topics and techniques_
...
[MCP Custom agents configuration](https://docs.github.com/en/copilot/reference/custom-agents-configuration)
